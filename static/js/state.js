export const dom = {
  ...
  openAnalyticsButton: document.getElementById("open-analytics"),
  analyticsModal: document.getElementById("analytics-modal"),
  closeAnalyticsButton: document.getElementById("close-analytics"),
  analyticsStatus: document.getElementById("analytics-status"),
  analyticsMetrics: document.getElementById("analytics-metrics"),
  analyticsErrorChart: document.getElementById("analytics-error-chart"),
  analyticsTopErrors: document.getElementById("analytics-top-errors"),
  analyticsTimeChart: document.getElementById("analytics-time-chart"),
